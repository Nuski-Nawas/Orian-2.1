# OrianWave - Digital Agency Website ( )

## Overview

A high-performance static site built with Vite + Tailwind CSS v4, positioned as the official website for **OrianWave** — 's AI-powered digital agency. The active site section uses the `digital-marketing-*` page prefix. All other page prefixes (ai-chatbot, ai-gadgets, etc.) are inactive template variants.
...
- `digital-marketing/dm-services-intro.htm` — Full digital marketing services overview: stats bar, 6-service grid, "Why OrianWave" section
